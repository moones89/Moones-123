...
import { Pill, Users, Star, TrendingUp, ArrowUpRight, Package, UserCog, MessageSquare } from 'lucide-react-native';
      ...
      <ScrollView style={styles.content}>
        <View style={styles.header}>
          <View>
            ...
            <Text style={styles.subtitle}>Welcome back, City Pharmacy</Text>
          </View>
          ...
          {metrics.map((metric) => (
            <View key={metric.title} style={styles.metricCard}>
              <View style={[styles.iconContainer, { backgroundColor: `${metric.color}20` }]}>
                {metric.title === 'Total Sales' && <Pill size={24} color={metric.color} />}
                {metric.title === 'Total Products' && <Package size={24} color={metric.color} />}
