...
import { Package, Users, Star, TrendingUp, ArrowUpRight, Boxes, UserCog, MessageSquare } from 'lucide-react-native';
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.content}>
        <View style={styles.header}>
          <View>
            <Text style={styles.title}>Supermarket Dashboard</Text>
            <Text style={styles.subtitle}>Welcome back, John's Market</Text>
          </View>
          ...
          {metrics.map((metric) => (
            <View key={metric.title} style={styles.metricCard}>
              <View style={[styles.iconContainer, { backgroundColor: `${metric.color}20` }]}>
                {metric.title === 'Total Sales' && <Package size={24} color={metric.color} />}
                {metric.title === 'Total Products' && <Boxes size={24} color={metric.color} />}
